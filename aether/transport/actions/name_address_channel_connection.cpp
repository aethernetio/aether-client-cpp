...
void NameAddressChannelConnectionAction::NameResolve(
  ...
  dns_resolve_subscriptions_.Push(
      resolver_action.SubscribeOnResult([this](auto const& action) {
      ...
      resolver_action.SubscribeOnError(
...
void NameAddressChannelConnectionAction::TryConnection(
  ...
  address_subscriptions_.Push(
      ip_address_channel_connection_->SubscribeOnResult([this](auto const&) {
      ...
      ip_address_channel_connection_->SubscribeOnError([this](auto const&) {
