...
#ifndef AETHER_TRANSPORT_LOW_LEVEL_SOCKETS_ISOCKET_H_
#define AETHER_TRANSPORT_LOW_LEVEL_SOCKETS_ISOCKET_H_
...
#endif  // AETHER_TRANSPORT_LOW_LEVEL_SOCKETS_ISOCKET_H_
