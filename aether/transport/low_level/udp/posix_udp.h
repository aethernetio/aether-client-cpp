 ...
 */
#ifndef AETHER_TRANSPORT_LOW_LEVEL_UDP_POSIX_UDP_H_
#define AETHER_TRANSPORT_LOW_LEVEL_UDP_POSIX_UDP_H_
...
namespace ae {
class PosixUdpTransport : public ITransport {
  static constexpr std::size_t kMaxPacketSize = 1200;

  class ReadAction final : public Action<ReadAction> {
   public:
    ReadAction(ActionContext action_context, PosixUdpTransport& transport);
  ...
  class SendAction final : public SocketPacketSendAction {
   public:
    SendAction(ActionContext action_context, PosixUdpTransport& transport,
 ...
 public:
  PosixUdpTransport(ActionContext action_context, IPoller::ptr const& poller,
...
#endif  // AETHER_TRANSPORT_LOW_LEVEL_UDP_POSIX_UDP_H_
