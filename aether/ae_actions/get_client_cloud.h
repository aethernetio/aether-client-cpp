...
namespace ae {
class GetClientCloudAction final : public a2::Action {
 public:
  using ResultEvent = Event<void(Result<std::vector<ServerId> const&, int>)>;
 ...
 private:
  ...
  MultiSubscription cloud_request_subs_;
