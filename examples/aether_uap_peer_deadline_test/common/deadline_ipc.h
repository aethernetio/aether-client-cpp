...
#ifndef EXAMPLES_AETHER_UAP_PEER_DEADLINE_TEST_COMMON_DEADLINE_IPC_H_
#define EXAMPLES_AETHER_UAP_PEER_DEADLINE_TEST_COMMON_DEADLINE_IPC_H_
...
#endif  // EXAMPLES_AETHER_UAP_PEER_DEADLINE_TEST_COMMON_DEADLINE_IPC_H_
