...
#ifndef AETHER_UAP_DELIVERY_TIMING_BENCH_COMMON_BENCH_IPC_H_
#define AETHER_UAP_DELIVERY_TIMING_BENCH_COMMON_BENCH_IPC_H_
...
#endif  // AETHER_UAP_DELIVERY_TIMING_BENCH_COMMON_BENCH_IPC_H_
