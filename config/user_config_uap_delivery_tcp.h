...
#ifndef CONFIG_USER_CONFIG_UAP_DELIVERY_TCP_H_
#define CONFIG_USER_CONFIG_UAP_DELIVERY_TCP_H_
...
// TCP-only work path: registration and work servers use TCP.
#define AE_SUPPORT_UDP 0
#define AE_SUPPORT_TCP 1
#define AE_UAP_DELIVERY_REQUIRE_UDP 0
...
#endif /* CONFIG_USER_CONFIG_UAP_DELIVERY_TCP_H_ */
