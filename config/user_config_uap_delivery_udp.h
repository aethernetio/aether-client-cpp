...
#ifndef CONFIG_USER_CONFIG_UAP_DELIVERY_UDP_H_
#define CONFIG_USER_CONFIG_UAP_DELIVERY_UDP_H_
...
// Bench measured work path must be UDP (registration may still be TCP).
#define AE_UAP_DELIVERY_REQUIRE_UDP 1
...
// Quiet console tele for bench runs.
...
#endif /* CONFIG_USER_CONFIG_UAP_DELIVERY_UDP_H_ */
